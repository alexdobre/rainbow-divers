        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600">
              Navigate through St Lucia's lush mangrove rivers and hidden waterways
            </p>
          </div>
          ...
          <div className="mt-12 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-xl p-8 shadow-xl text-white text-center">
            <h2 className="text-2xl font-bold mb-4">Explore the Mangroves</h2>
            <p className="text-lg mb-6 text-blue-100">
              Paddle through serene mangrove ecosystems and discover St Lucia's natural beauty from a unique perspective
            </p>
